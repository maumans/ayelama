...
const SOC_BASE = [
    ...
    { id: 'soc.capital_chiffres', label: 'Capital social (GNF)', type: 'number', placeholder: '50 000 000', required: true, mono: true },
    { id: 'soc.nombre_parts', label: 'Nombre de parts sociales', type: 'number', placeholder: '100', required: true, mono: true },
    { id: 'soc.valeur_nominale_chiffres', label: "Valeur nominale d'une part (GNF)", type: 'number', placeholder: '500 000', required: true, mono: true },
    ...
    { id: 'soc.duree', label: 'Durée (années)', type: 'number', placeholder: '99', required: false },
    { id: 'soc.premier_exercice_annee', label: '1er exercice — année', type: 'number', placeholder: '2026', required: false },
    { id: 'soc.email_societe', label: 'Email de la société', type: 'text', placeholder: 'contact@societe.com', required: false },
    { id: 'soc.telephone_societe', label: 'Téléphone de la société', type: 'tel', placeholder: '622 XX XX XX', required: false },
];
...
export const QUESTIONNAIRES = {
    ...
    creation_sa: [
        ...
        { id: 'soc.capital_chiffres', label: 'Capital social (GNF — min. 140 000 000)', type: 'number', placeholder: '140000000', required: true, mono: true },
        { id: 'soc.capital_libere_chiffres', label: 'Capital libéré à la constitution (min. 35 000 000)', type: 'number', placeholder: '35000000', required: true, mono: true },
        { id: 'soc.nombre_actions', label: "Nombre d'actions", type: 'number', placeholder: '14000', required: true, mono: true },
        { id: 'soc.valeur_nominale_chiffres', label: "Valeur nominale d'une action (GNF)", type: 'number', placeholder: '10000', required: true, mono: true },
        { id: 'soc.siege_quartier', label: 'Quartier du siège social', type: 'text', placeholder: 'Almamya', required: true },
        { id: 'soc.siege_commune', label: 'Commune du siège social', type: 'text', placeholder: 'Kaloum', required: true },
        { id: 'soc.siege_ville', label: 'Ville du siège social', type: 'text', placeholder: 'Conakry', required: true },
        { id: 'soc.objet_social', label: 'Objet social', type: 'textarea', placeholder: 'Commerce général, import-export…', required: true },
    ...
    creation_gie: [
        ...
        { id: 'soc.capital_chiffres', label: 'Capital (GNF — facultatif)', type: 'number', placeholder: '0 si pas de capital', required: false, mono: true },
        ...
        { id: 'soc.duree', label: 'Durée (années)', type: 'number', placeholder: '10', required: false },
        {
    ...
    dissolution: [
        ...
        { id: 'soc.siege_commune', label: 'Commune du siège', type: 'text', placeholder: 'Kaloum', required: true },
        { id: 'soc.siege_ville', label: 'Ville du siège', type: 'text', placeholder: 'Conakry', required: true },
        { id: 'dissolution.date_assemblee', label: "Date de l'assemblée de dissolution", type: 'date', placeholder: '01/07/2026', required: true, section: 'Décision de dissolution' },
    ...
    vente_immeuble: [
        ...
        { id: 'bien.superficie', label: 'Superficie (m²)', type: 'number', placeholder: '500', required: true, mono: true },
        ...
        { id: 'bien.prix_vente_chiffres', label: 'Prix de vente (GNF)', type: 'number', placeholder: '250000000', required: true, mono: true, section: 'Transaction' },
    ...
    bail_habitation: [
        ...
        { id: 'bien.superficie', label: 'Superficie (m²)', type: 'number', placeholder: '120', required: false, mono: true },
        { id: 'bien.usage', label: 'Usage', type: 'select', options: ['Résidentiel', 'Usage mixte'], required: true },
        { id: 'bail.date_prise_effet', label: "Date de prise d'effet", type: 'date', placeholder: '01/08/2026', required: true, section: 'Conditions du bail' },
        { id: 'bail.duree_chiffres', label: 'Durée du bail (années)', type: 'number', placeholder: '2', required: true, mono: true },
        { id: 'bail.loyer_chiffres', label: 'Loyer mensuel (GNF)', type: 'number', placeholder: '5000000', required: true, mono: true },
        ...
        { id: 'bail.caution_chiffres', label: 'Caution (GNF)', type: 'number', placeholder: '10000000', required: false, mono: true },
        { id: 'bail.avance_loyer', label: "Avance sur loyer (mois)", type: 'number', placeholder: '3', required: false, mono: true },
    ...
    bail_commercial: [
        ...
        { id: 'bien.superficie', label: 'Superficie (m²)', type: 'number', placeholder: '80', required: false, mono: true },
        { id: 'bail.date_prise_effet', label: "Date de prise d'effet", type: 'date', placeholder: '01/08/2026', required: true, section: 'Conditions du bail' },
        { id: 'bail.duree_chiffres', label: 'Durée du bail (années)', type: 'number', placeholder: '3', required: true, mono: true },
        { id: 'bail.loyer_chiffres', label: 'Loyer mensuel (GNF)', type: 'number', placeholder: '20000000', required: true, mono: true },
        { id: 'bail.periodicite', label: 'Périodicité du paiement', type: 'select', options: ['Mensuel', 'Trimestriel', 'Semestriel', 'Annuel'], required: true },
        { id: 'bail.caution_chiffres', label: 'Caution (GNF)', type: 'number', placeholder: '60000000', required: false, mono: true },
        { id: 'bail.droit_entree_chiffres', label: "Droit d'entrée / Pas-de-porte (GNF)", type: 'number', placeholder: '0', required: false, mono: true },
    ...
    bail_construction: [
        ...PP_BAILLEUR,
        ...LOC_PRENEUR,
        { id: 'bien.superficie', label: 'Superficie du terrain (m²)', type: 'number', placeholder: '2000', required: true, mono: true, section: 'Terrain' },
        { id: 'bien.lieu_de', label: 'Situé à', type: 'text', placeholder: 'Quartier, Commune, Ville', required: true },
        ...
        { id: 'bail.date_prise_effet', label: "Date de prise d'effet", type: 'date', placeholder: '01/08/2026', required: true, section: 'Conditions du bail' },
        { id: 'bail.duree_chiffres', label: 'Durée du bail à construction (années)', type: 'number', placeholder: '30', required: true, mono: true },
        { id: 'bail.loyer_chiffres', label: 'Redevance annuelle (GNF)', type: 'number', placeholder: '10000000', required: true, mono: true },
        ...
        { id: 'bail.valeur_constructions_chiffres', label: 'Valeur estimée des constructions (GNF)', type: 'number', placeholder: '500000000', required: false, mono: true },
    ...
    hypotheque_conv: [
        ...
        { id: 'bien.superficie', label: 'Superficie (m²)', type: 'number', placeholder: '500', required: false, mono: true },
        { id: 'bien.lieu_de', label: 'Situé à', type: 'text', placeholder: 'Quartier, Commune, Ville', required: true },
    ...
    modification: [
        { id: 'soc.denomination', label: 'Dénomination de la société', type: 'text', placeholder: 'Raison sociale exacte', required: true, section: 'Société concernée' },
        { id: 'soc.rccm', label: 'Numéro RCCM actuel', type: 'text', placeholder: 'GN-CON-2020-B-XXXX', required: true, mono: true },
        { id: 'objet_modification', label: 'Objet de la modification', type: 'textarea', placeholder: 'Décrire les changements apportés (capital, gérant…)', required: true, section: 'Modification' },
