export default function GuestPublicLayout({ children, officeNom = 'Ayelema' }) {
    return (
        ...
        >
            {/* min-h-full (pas h-full) + justify-center sur ce panneau intérieur, pas sur le
                conteneur défilant lui-même — combiner overflow-y-auto et justify-center sur le
                même élément flex rend le haut du contenu inatteignable au scroll dans certains
                navigateurs dès que le contenu dépasse la hauteur de l'écran (formulaires longs). */}
            <div className="min-h-full flex flex-col items-center justify-center p-6">
                ...
                <div className="w-full max-w-[760px] rounded-2xl border border-slate-200 bg-white shadow-[0_20px_60px_-15px_rgba(15,45,96,0.15)] p-6 sm:p-8">
                    {children}
                </div>
